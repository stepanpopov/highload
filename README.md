...
<img src="https://github.com/stepanpopov/highload-google-drive/assets/77172612/313a6c6e-99fe-4e87-945b-e8e64c57b725" width="600">
...
- file_uuid = 16 байт
- file_name = 32 байт
- В среднем пользователи хранят 15 папок по 20 символов\
  path = 15 * 20 = 300 байт
- file_size = 4 байт
- file_type = 30 байт
- s3_url = 256 байт
...
Общее: 
- ((16 + 32 + 4 + 30 + 256) байт * 3200(среднее кол-во файлов у пользователя) + 8 байт) * 700m = 688 Tib

### Схема таблиц для хранения файлов небольшого размера:
<img src="https://github.com/stepanpopov/highload-google-drive/assets/77172612/1fb021d5-1fd8-44f2-a05b-fd0d2ef19c58" width="500">
...
Так как загрузка в S3 файлов небольшого размера нагружает сеть и может привести к неоптимальному хранению файлов.
Небольшие файлы(до 1 мб) будем хранить блобами в базе данных.
Как только общий размера файлов небольшого размера достигает 20 GB, делаем bulk инсерт в s3 с помощью AWS Snowball.
