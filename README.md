...
Общее: (16 + 32 + 60 + 4 + 30 + 256) байт * 700m = 259 Gib
...
Общие права будут истекать через месяц.\
...
Общее: (16 байт + 16 байт + 1 байт) * 67M(MAU) * 3200(среднее кол-во файлов у пользователя) * 3 / 10 = 1.9 TiB.
